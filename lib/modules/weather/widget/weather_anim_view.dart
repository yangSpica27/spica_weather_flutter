...
/// 天气动画视图[沙尘暴]
class _SandstormView extends StatefulWidget {
  const _SandstormView({required this.width, required this.height});
  ...
  @override
  State<_SandstormView> createState() => _SandstormViewState();
}
...
class _SandstormViewState extends State<_SandstormView>
    with SingleTickerProviderStateMixin {
